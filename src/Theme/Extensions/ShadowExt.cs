...
namespace Aldwych.Theme
{
    ...
    {
        public static Color MaterialShadowColor { get; set; } = Color.FromArgb(64, 0, 0, 0);
        //public static Color MaterialShadowColor { get; set; } = Color.FromArgb(255, 255, 0, 0);
        ...
        public static BoxShadows ToBoxShadows(this ShadowDepth shadowDepth, Color? overridedColor = null)
        {
            return shadowDepth switch
            {
                ...
                ShadowDepth.Depth1 => new BoxShadows(new BoxShadow { Blur = 4, OffsetX = 0, OffsetY = 4, Color = overridedColor ?? MaterialShadowColor }),
